...
export default function PrivacyNotice() {
  ...
  return (
    <div className="container">
      <h1 className="offset-xl-2 offset-lg-3 display-1">{t('legal:privacy.title')}</h1>
      <p className="offset-xl-2 offset-lg-3 lead">{t('legal:privacy.description')}</p>
      ...
      <div className="row">
          ...
          <ul className="nav flex-column">
            {Array.apply(null, Array(12)).map((v, i) =>
              <li key={i} className="nav-item">
                <a className="nav-link" href={`#chapter${i + 1}`}>{t(`legal:privacy.chapter${i + 1}.title`)}</a>
              </li>
            )}
          </ul>
        </div>
        <div className="col">
          ...
          <p><Trans i18nKey="legal:privacy.chapter5.list1" /></p>
          <p><Trans i18nKey="legal:privacy.chapter5.list2" /></p>
          <p><Trans i18nKey="legal:privacy.chapter5.list3" /></p>
          <p><Trans i18nKey="legal:privacy.chapter5.list4" /></p>
          <p><Trans i18nKey="legal:privacy.chapter5.list5" /></p>
          <p><Trans i18nKey="legal:privacy.chapter5.list6" /></p>
          ...
          <p>
            <Trans i18nKey="legal:privacy.chapter6.link">
              For further information, visit <a href="//en.wikipedia.org/wiki/HTTP_cookie" rel="noreferrer" target="_blank">wikipedia</a>.
            </Trans>
          </p>
