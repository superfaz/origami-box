        ...
        <div className="collapse navbar-collapse" id="navbar">
          <ul className="navbar-nav me-auto">
            <li className="nav-item">
              <NavLink className="nav-link" exact to="/" onClick={collapse}>
                {t("navbar.home")}
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="/templates" onClick={collapse}>
                {t("navbar.templates")}
              </NavLink>
            </li>
                ...
                {languages.map((lng) => (
                  <button
                    ...
                    className={classNames(
                      "btn",
                      { "btn-secondary": i18n.language === lng },
                      { "btn-outline-secondary": i18n.language !== lng }
                    )}
                    onClick={() => {
